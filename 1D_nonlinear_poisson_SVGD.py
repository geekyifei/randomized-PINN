...
nIter = args.nIter
num_print = 20
path_f   = f'1D_nonlinear_poisson_SVGD_Nres_{Nres}_sigma_{sigma}_Nsamples_{Nsamples}_nIter_{nIter}'
...
ts = perf_counter()
samples = model.svgd_train(key2, Nsamples, nIter = nIter, num_print = num_print, bandwidth = 5, u_ref = u, f_ref = f)
timings = perf_counter() - ts
print(f"SVGD: {timings} s")
